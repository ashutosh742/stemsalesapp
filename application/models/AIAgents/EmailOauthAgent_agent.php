 ...
 *
 * Cron schedule:
 *   */5  * * * *  php /var/www/stemapp.in/index.php email_oauth_agent run_email_poll
 *   */15 * * * *  php /var/www/stemapp.in/index.php email_oauth_agent run_calendar_poll
 *
...
class Email_oauth_agent extends CI_Model
{
    ...
    public function thread_linker($message_id, $uid)
    {
        ...
        //       Assumed: init_call.email_id. Adjust if different.
        $sql_ic = "
            SELECT id AS cid_id
              FROM init_call
              WHERE mainbd = ?
