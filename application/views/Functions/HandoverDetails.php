                  ...
                  <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important" class='text-center'>
                            ...
                            */ ?>
                            ...
                            <td>
                              <?= !empty($row->$row->handover_closed_date) ? $row->$row->handover_closed_date : "-" ?>
                            </td>
                            <td>
                              <?= !empty($row->$row->handover_closed_remarks) ? $row->$row->handover_closed_remarks : "-" ?>
                            </td>
                            <td>
                              <?php if(!empty($row->handover_closed_by)){ 
                                 $handoverClosedBYUserdetail = $this->Menu_model->get_userbyid($row->handover_closed_by);
                                 if(sizeof($handoverClosedBYUserdetail) > 0){
