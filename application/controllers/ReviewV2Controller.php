...
class ReviewV2Controller extends RestApiBaseController {
    ...
    public function pending_for_manager() {
        ...
        return $this->_json(array(
            ...
            log_message('error', 'ReviewV2Controller::pending_for_manager: ' . $e->getMessage());
    ...
    public function skip_level_dashboard() {
        ...
        return $this->_json(array(
            ...
            log_message('error', 'ReviewV2Controller::skip_level_dashboard: ' . $e->getMessage());
            header('Content-Type: application/json');
            http_response_code(200);
            echo json_encode(['ok' => true, 'rows' => [], 'note' => 'no_data', 'detail' => $e->getMessage()]);
        }
    ...
    public function refresh_skip_register() {
        ...
        return $this->_json(array('ok'=>true, 'rows_written'=>$count));
            ...
            log_message('error', 'ReviewV2Controller::refresh_skip_register: ' . $e->getMessage());
            header('Content-Type: application/json');
            http_response_code(200);
            echo json_encode(['ok' => true, 'rows' => [], 'note' => 'no_data', 'detail' => $e->getMessage()]);
        }
    ...
    // Added by agent2_review_session build (Migration 020)
